...
class UserController extends Controller
{
    protected function index(){
        ...
        $user_list = User::all()->sortBy('id');
        return view('user.index', compact('user_list', 'jumlah_user'));
    }
    ...
    public function destroy($id){
        ...
        $cari_peminjam = DataPeminjam::where('user_id', $id)->pluck('id');
        $cari_peminjaman = Peminjaman::where('id_peminjam', $cari_peminjam)->get();
